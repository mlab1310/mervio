...
TABLES = ("reports", "analysis_runs", "ad_daily_performance", "campaigns", "refunds", "payments", "order_lines",
          "orders", "products", "snapshot_sources", "data_snapshots", "connections", "stores", "memberships",
          "users", "organizations")
